...
class AppSmallBlackButton extends StatelessWidget {
  final Function() onPressed;
  final String text;
  AppSmallBlackButton({required this.onPressed, required this.text});
    ...
    return Padding(
      ...
      child: SizedBox(
        ...
        child: ElevatedButton(
          ...
          child: Text(
            text,
            style: AppLightTextStyle.appSmallBlackButton,
          ),
        ),
      ),
    );
